...
const HeroPage = () => {
  ...
  return (
    <section className='min-h-screen w-full flex flex-col relative text-white' id='hero'>
      <div className='w-full mx-auto flex flex-col sm:mt-36 mt-20 gap-3 sm:px-10 px-5 items-center text-cente'>
