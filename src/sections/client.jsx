    ...
    <section className="sm:px-10 px-5 my-20">
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-5 mt-12 ">
        {clientReviews.map((item) => (
          <div key={`review-${item.id}`} className="rounded-lg md:p-10 p-5 col-span-1  hover:scale-[1.02] transition-transform duration-300 bg-[#0E0E10] bg-opacity-50">
            <div>
              <p className="text-[#afb0b6] font-light sm:text-[18px] text-[15px]">{item.review}</p>
              ...
              <div className="flex lg:flex-row flex-col justify-between lg:items-center items-start gap-5 mt-7 ">
                <div className="flex gap-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-[#a0a3b3] md:text-base text-sm font-light">{item.position}</p>
                  </div>
                </div>
